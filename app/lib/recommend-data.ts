...
export const COUNTRY_RECOMMENDATIONS: Record<string, CountryRecommendation> = {
  TH: { countryName: 'Thailand', baseCurrency: 'THB', languages: ['en', 'zh-CN', 'zh-TW', 'ja', 'ko'] },
  JP: { countryName: 'Japan', baseCurrency: 'JPY', languages: ['en', 'zh-CN', 'zh-TW', 'ko', 'ja'] },
  HK: { countryName: 'Hong Kong', baseCurrency: 'HKD', languages: ['en', 'zh-CN', 'zh-TW', 'ja', 'ko'] },
  KR: { countryName: 'South Korea', baseCurrency: 'KRW', languages: ['en', 'zh-CN', 'zh-TW', 'ja', 'ko'] },
  TW: { countryName: 'Taiwan', baseCurrency: 'TWD', languages: ['en', 'zh-TW', 'zh-CN', 'ja', 'ko'] },
  SG: { countryName: 'Singapore', baseCurrency: 'SGD', languages: ['en', 'zh-CN', 'zh-TW', 'ja', 'ko', 'ms'] },
  MY: { countryName: 'Malaysia', baseCurrency: 'MYR', languages: ['en', 'zh-CN', 'ms', 'ja', 'ko'] },
  ID: { countryName: 'Indonesia', baseCurrency: 'IDR', languages: ['en', 'zh-CN', 'ja', 'ko', 'ms'] },
  VN: { countryName: 'Vietnam', baseCurrency: 'VND', languages: ['en', 'zh-CN', 'vi', 'ja', 'ko'] },
  PH: { countryName: 'Philippines', baseCurrency: 'PHP', languages: ['en', 'zh-CN', 'ja', 'ko'] },
  IN: { countryName: 'India', baseCurrency: 'INR', languages: ['en', 'zh-CN', 'ja', 'ko'] },
  ...
  US: { countryName: 'United States', baseCurrency: 'USD', languages: ['en', 'zh-CN', 'zh-TW', 'ja', 'ko', 'fr', 'de'] },
  RU: { countryName: 'Russia', baseCurrency: 'RUB', languages: ['en', 'zh-CN', 'ja', 'ko'] },
  LA: { countryName: 'Laos', baseCurrency: 'USD', languages: ['en', 'zh-CN', 'ja', 'ko', 'vi'] },
  AE: { countryName: 'UAE', baseCurrency: 'USD', languages: ['en', 'zh-CN', 'zh-TW', 'ja', 'ko'] },
  ...
  NP: { countryName: 'Nepal', baseCurrency: 'USD', languages: ['en', 'zh-CN', 'ja', 'ko'] },
